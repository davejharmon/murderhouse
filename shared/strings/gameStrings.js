...
export const STRING_CATALOG = [
  ...
  { cat: "slides", key: "flow.condemnedSubtitle", default: "Calling the judge...", tags: ["judge","judgePardon"], desc: "Subtitle while Judge decides" },
  ...
  { cat: "slides", key: "flow.pardonedSubtitle", default: "{name} was not eliminated.", tokens: ["{name}"], tags: ["judge","judgePardon"], desc: "Subtitle when player is pardoned" },
  ...
  { cat: "log", key: "hunterSuspected", default: "{name} suspects {target}", tokens: ["{name}","{target}"], tags: ["suspect","hunter"], desc: "Log when hunter/nobody records a suspicion" },
