...
export const STRING_CATALOG = [
  ...
  { cat: "log", key: "killProtected", default: "{actor} failed to kill {name} (Protected)", tokens: ["{actor}","{name}"], tags: ["kill","protect","doctor"], desc: "Log when alpha kill is blocked by doctor protection" },
  { cat: "log", key: "poisonedPlayer", default: "{name} was poisoned", tokens: ["{name}"], tags: ["poisoner","poison"], desc: "Log when poisoner applies delayed kill (no actor known)" },
  { cat: "log", key: "poisonerPoisoned", default: "{actor} poisoned {name}", tokens: ["{actor}","{name}"], tags: ["poisoner","poison"], desc: "Log when poisoner applies delayed kill via the kill event" },
  ...
  { cat: "log", key: "vigilanteProtected", default: "{name} failed to shoot {target} (Protected)", tokens: ["{name}","{target}"], tags: ["vigil","vigilante","protect","doctor"], desc: "Log when vigilante kill is blocked by doctor protection" },
  { cat: "log", key: "roleblockFailed", default: "{name} failed to {verb} {target} (Roleblocked)", tokens: ["{name}","{verb}","{target}"], tags: ["block","roleblocker"], desc: "Log when a roleblocked player's night action is nullified" },
