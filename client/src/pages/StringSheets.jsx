...
function buildJsFile(catalog, overrides) {
  const lines = [
...
export default function StringSheets() {
  ...
  function handleReset() {
    if (!confirm('Reset all values to defaults? This clears localStorage.')) return
  ...
  function handleDownloadJs() {
    const js = buildJsFile(STRING_CATALOG, overrides)
  ...
  function getEntryTags(entry) {
    ...
    const autoTag = autoGroup?.tags.find(t => t.id === prefix)
    return autoTag ? [autoTag.id, ...explicit] : explicit
  }
