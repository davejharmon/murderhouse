...
export const MOCK_PLAYERS = [
  { id: 1, name: 'Alice',   portrait: 'player1.png', status: PlayerStatus.ALIVE, roleTeam: 'citizens',  roleName: 'Citizen',  roleColor: '#7eb8da', roleEmoji: '🧑', isCowering: false, hasNovote: false, heartbeat: { active: true, bpm: 88,  fake: false } },
  { id: 2, name: 'Bob',     portrait: 'player2.png', status: PlayerStatus.ALIVE, roleTeam: 'children', roleName: 'Child',  roleColor: '#c94c4c', roleEmoji: '🐺', isCowering: false, hasNovote: false, heartbeat: { active: true, bpm: 120, fake: false } },
  { id: 3, name: 'Carol',   portrait: 'player3.png', status: PlayerStatus.ALIVE, roleTeam: 'citizens',  roleName: 'Detective',      roleColor: '#c9a94c', roleEmoji: '🔮', isCowering: true,  hasNovote: false, heartbeat: { active: true, bpm: 72,  fake: false } },
  { id: 4, name: 'Dave',    portrait: 'player4.png', status: PlayerStatus.DEAD,  roleTeam: 'children', roleName: 'Child',  roleColor: '#c94c4c', roleEmoji: '🐺', isCowering: false, hasNovote: false, heartbeat: { active: false, bpm: 0,  fake: false }, deathTimestamp: 1000 },
  { id: 5, name: 'Eve',     portrait: 'player5.png', status: PlayerStatus.ALIVE, roleTeam: 'citizens',  roleName: 'Doctor',    roleColor: '#7ed9a6', roleEmoji: '💉', isCowering: false, hasNovote: true,  heartbeat: { active: true, bpm: 95,  fake: false } },
  { id: 6, name: 'Frank',   portrait: 'player6.png', status: PlayerStatus.ALIVE, roleTeam: 'outsider',  roleName: 'Trickster',    roleColor: '#e8a020', roleEmoji: '🃏', isCowering: false, hasNovote: false, heartbeat: { active: true, bpm: 78,  fake: true  } },
]
...
export const MOCK_SLIDES = {
  ...
  [SlideType.PLAYER_REVEAL]: {
    ...
    title: 'VOTED OUT',
    subtitle: 'The citizens have spoken',
    playerId: 3,
    revealRole: true,
  ...
  [SlideType.DEATH]: {
    ...
    remainingComposition: [
      { team: 'citizens', dim: false },
      { team: 'citizens', dim: false },
      { team: 'children', dim: false },
      { team: 'children', dim: true },
    ],
  },
  ...
  [`${SlideType.DEATH}_coward`]: {
    ...
    coward: true,
    style: SlideStyle.WARNING,
    revealText: 'Detective — fled in shame',
  },

  [SlideType.VICTORY]: {
    id: 'mock-victory',
    type: SlideType.VICTORY,
    title: 'THE CITIZENS WIN',
    subtitle: 'The children have been defeated',
    style: SlideStyle.POSITIVE,
    winners: [
      { id: 1, name: 'Alice', portrait: 'player1.png', isAlive: true,  roleColor: '#7eb8da', roleName: 'Citizen' },
      { id: 3, name: 'Carol', portrait: 'player3.png', isAlive: false, roleColor: '#c9a94c', roleName: 'Detective' },
  ...
  [`${SlideType.VICTORY}_cell`]: {
    ...
    type: SlideType.VICTORY,
    title: 'THE CHILDREN WIN',
    subtitle: 'The citizens have fallen',
    style: SlideStyle.HOSTILE,
    winners: [
      { id: 2, name: 'Bob',  portrait: 'player2.png', isAlive: true, roleColor: '#c94c4c', roleName: 'Child' },
    ],
  },
  ...
  [SlideType.COMPOSITION]: {
    ...
    title: 'GAME SETUP',
    roles: [
      { roleId: 'child', roleName: 'Child', roleEmoji: '🐺', team: 'children', count: 2 },
      { roleId: 'citizen', roleName: 'Citizen', roleEmoji: '🧑', team: 'citizens',  count: 3 },
      { roleId: 'detective',     roleName: 'Detective',     roleEmoji: '🔮', team: 'citizens',  count: 1 },
      { roleId: 'doctor',   roleName: 'Doctor',   roleEmoji: '💉', team: 'citizens',  count: 1 },
    ],
  ...
  [`${SlideType.ROLE_TIP}_cell`]: {
    ...
    roleColor: '#c94c4c',
    team: 'children',
    detailedTip: 'Each night you and your children choose one player to eliminate.',
    abilities: [
